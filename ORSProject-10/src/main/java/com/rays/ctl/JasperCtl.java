...
//	  @Autowired 
	...
	public void display(HttpServletResponse response)
	    ...
	    InputStream reportStream =
	        getClass().getClassLoader().getResourceAsStream("orsproject_10_report.jrxml");

	    if (reportStream == null) {
	        throw new FileNotFoundException("orsproject_10_report.jrxml jasper not found in classpath");
	    }
